...
<div class="page-content" id="content">
    ...
    <!-- Contact Form -->
    <div class="container contact col-md-6 col-lg-9 d-flex p-3 rounded-3 ">
        <div class="other d-flex">
            <div class="info p-4">
                <h2 class="text-warning">More Methods </h2>
                <h3 class="text-light p-1">Email</h3>
                <div class="svg-wrap d-flex mt-3"> <a href="mailto:gymm@gmail.com"><svg
                        ...
                        </svg> gymm@gmail</a> </div>
                <h3 class="text-light p-1">Connect</h3>
                <div class="svg-wrap d-flex mt-3"> <a href="https://www.instagram.com/" target="_blank"><svg
                        ...
                        </svg></a> <a href="https://www.facebook.com/" target="_blank"><svg
        ...
        <div class="form bg-white p-4 d-flex">
            ...
            if (isset($_POST["button"])) {
                ...
                if (isset($_POST['firstName']) && $_POST['firstName']) {
                    ...
                    if (!checkFirstName($firstName)) {
                        $chyby['firstName'] = 'FirstName has bad format.';
                        echo "First name: $firstName <br>";
                    }
                } else {
                    $firstName = '';
                    $chyby['firstName'] = 'You did not enter a name !';
                }
                ...
                if (isset($_POST['lastName']) && $_POST['lastName']) {
                    ...
                    if (!checkLasttName($lastName)) {
                        $chyby['lastName'] = 'LastName has bad format.';
                    }
                } else {
                    $lastName = '';
                    $chyby['lastName'] = 'You did not enter a lastName !';
                }
                ...
                if (isset($_POST['phone']) && $_POST['phone']) {
                    ...
                    if (!checkPhone($phone)) {
                        $chyby['phone'] = 'Phone has bad format.';
                    }
                } else {
                    $phone = '';
                    $chyby['phone'] = 'You did not enter a phone number !';
                }
            ...
            <form action="contact.php" class="d-flex" method="post">
                <div class="flex-rev d-flex"> <input type="text" placeholder="Name" name="firstName" id="firstName" />
                    <label for="name">First Name</label>
                </div>
                <div class="flex-rev d-flex"> <input type="text" placeholder="Name" name="lastName" id="lastName" />
                    <label for="name">Last Name</label>
                </div>
                <div class="flex-rev d-flex"> <input type="email" placeholder="email@gmail.com" name="email"
                        id="email" />
                    <label for="email">Your Email</label>
                </div>
                <div class="flex-rev d-flex"> <input type="text" placeholder="0908 ... ..." name="phone" id="phone" />
                    <label for="email">Your Phone</label>
                </div>
                <div class="flex-rev d-flex"> <textarea placeholder="Hello ..." name="message"
                        id="message" /></textarea>
